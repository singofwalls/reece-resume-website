...
class index(TemplateView):
    ...
    experiences = [
        Experience("Research Assistant", 
            ...
            "Dr. John Paden",
            "Upgraded a web-application's entire stack including the server hardware, OS, database, backend code, and frontend code. Adds features to Matlab and Django code bases.", 
        ...
        Experience("IT Lead", 
            ...
            "Trey Scarborough",
            "Maintains and upgrades the economy simulation used by the Kansas Boys State program to provide an interactive experience to the participants during the annual week-long session. Writes scripts to automate various IT tasks. Images computers.", 
